                ...
                <Container>
                    <div className="container">
                        <div className="display">
                            <button className="standard active">Standard</button>
                            <button className="standard">Deluxe</button>
                            <button className="standard">Executive</button>
                        </div>
                    </div>
                    ...
                    >
                        <Tab eventKey="description" title="DESCRIPTION">
                            <div className="row border g-0 rounded shadow-sm">
                                <div className="description-content">
                                    ...
                                    <p> <strong className="bold">Naran</strong> is a medium-sized town in upper
                                        Kaghan Valley
                                        in
                                    ...
                                    <p><b>Kaghan Valley</b> is an high mountains valley located in
                                        ...
                                        District of <a title="Khyber Pakhtunkhwa"
                                            ...
                                            Pakhtunkhwa</a>, Pakistan.<sup id="cite_ref-1"
                                                className="reference"></sup><sup id="cite_ref-2"
                                                    className="reference"></sup><sup id="cite_ref-3"
                                                        className="reference"></sup> The valley covers a distance of 155
                                        kilometers (96 mi)<sup id="cite_ref-4"
                                            className="reference"></sup> across northern Pakistan, rising from
                                        its
                                    ...
                                    <p><strong className="bold">Saiful Muluk</strong> is a mountainous lake
                                        located at the
                                    ...
                                    <p><strong className="bold">Places Covered</strong></p>
                                    ...
                                    <p><strong className="bold">Inclusions</strong><br />
                                        ...
                                        • BBQ &amp; Bonfire Night</p>
                                    <p><strong className="bold">Exclusions</strong><br />
                                ...
                                <ul className="timeline">
                                    ...
                                    <li>
                                        <div className="direction-r">
                                            ...
                                            <div className="flag-wrapper">
                                                <span className="flag">Day 0 : Departure.</span>
                                            </div>
                                            <div className="desc">
                                    ...
                                    <li>
                                        <div className="direction-r">
                                            ...
                                            <div className="flag-wrapper">
                                                <span className="flag">Day 1 : Balakot</span>
                                            </div>
                                            <div className="desc">
                                    ...
                                    <li>
                                        <div className="direction-r">
                                            ...
                                            <div className="flag-wrapper">
                                                <span className="flag">Day 2 : Naran</span>
                                            </div>
                                            <div className="desc">
                                    ...
                                    <li>
                                        <div className="direction-r">
                                            ...
                                            <div className="flag-wrapper">
                                                <span className="flag">Day 3 </span>
                                            </div>
                                            <div className="desc">
                        ...
                        <Tab eventKey="price" title="PRICE">
                            <div className="price-section">
                                <div id="price">
                                    <h2>Standard</h2>
                                    <p>Price: <span className="orange">Rs.15,000/-</span></p>
                                    <ul>
